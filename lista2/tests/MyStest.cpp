...
void mySort(vector<int>& arr, int &comp, int &swp) {
...
int main() {
    ifstream inFile("n50000k10data.txt");
    ofstream outFile("MySresults-n50000k10.txt");
    string line;
